...
var PushProductApp = React.createClass({
	...
	productRecieve: function productRecieve(product) {
		console.log('P', product);
	},
	sendPromo: function sendPromo() {
		var promoProduct = {
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement('input', { id: 'skuEl', type: 'text' }),
			React.createElement('br', null),
			React.createElement('br', null),
			React.createElement('input', { type: 'button', value: 'Send Promo', onClick: function () {
					return _this.sendPromo();
				} })
		);
	}
});

React.render(React.createElement(PushProductApp, null), document.getElementById('app'));

},{"jquery":2,"react":158}],2:[function(require,module,exports){
/*!
